defmodule Junky.BlogTest do
  use Junky.DataCase

  alias Junky.Blog

  describe "posts" do
    alias Junky.Blog.Post

    @valid_attrs %{body: "some body", published: true, published_at: ~N[2010-04-17 14:00:00.000000], title: "some title", views: 42}
